...
📈 On a mission to build startups, intelligent systems, and future-defining platforms.
 ...
 Currently exploring:
-  Python, C, C++, React, JavaScript & TypeScript
-  CAD
